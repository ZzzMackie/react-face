"use strict";var Q=Object.create;var w=Object.defineProperty;var $=Object.getOwnPropertyDescriptor;var Z=Object.getOwnPropertyNames;var ee=Object.getPrototypeOf,te=Object.prototype.hasOwnProperty;var oe=(e,t)=>{for(var r in t)w(e,r,{get:t[r],enumerable:!0})},O=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of Z(t))!te.call(e,s)&&s!==r&&w(e,s,{get:()=>t[s],enumerable:!(n=$(t,s))||n.enumerable});return e};var re=(e,t,r)=>(r=e!=null?Q(ee(e)):{},O(t||!e||!e.__esModule?w(r,"default",{value:e,enumerable:!0}):r,e)),ne=e=>O(w({},"__esModule",{value:!0}),e);var qe={};oe(qe,{ObjectPool:()=>C,ThreeRenderPlugin:()=>X,arrayToEuler:()=>ke,arrayToQuaternion:()=>Ue,arrayToVector3:()=>ze,clamp:()=>_e,computeBoundingBox:()=>K,computeBoundingSphere:()=>We,debounce:()=>Re,degreesToRadians:()=>He,disposeMaterial:()=>S,disposeObject:()=>Se,generateUUID:()=>Pe,getDevicePerformanceLevel:()=>Be,getRenderQualitySettings:()=>Ie,hexToRgb:()=>Le,injectThreeParent:()=>Ye,isSharedArrayBufferSupported:()=>je,isWebAssemblySupported:()=>Ae,isWebGPUSupported:()=>Ce,isWebWorkerSupported:()=>Me,lerp:()=>Fe,radiansToDegrees:()=>De,rgbToHex:()=>Ne,throttle:()=>Oe,toColor:()=>Ve,useFrame:()=>Xe,useParent:()=>Ke,useProvideThreeAPI:()=>Ge,useThree:()=>R});module.exports=ne(qe);var P=`<template>\r
...
</style> `;var L=`<script setup lang="ts">\r
...
</style> `;var F=`<script setup lang="ts">\r
...
</template> `;var _=`<script setup lang="ts">\r
import { ref, onMounted, onBeforeUnmount, inject, watch } from 'vue';\r
...
</template> `;var D=`<script setup lang="ts">\r
import { ref, onMounted, onBeforeUnmount, inject, watch } from 'vue';\r
...
</script> `;var V=`<script setup lang="ts">\r
...
</template> `;var W=`<script setup lang="ts">\r
import { ref, onMounted, onBeforeUnmount, watch } from 'vue';\r
import { useFrame } from '../../composables/useFrame';\r
\r
const props = defineProps<{\r
...
</style> `;var Y=`<script setup lang="ts">\r
import { ref, watch, onMounted, onBeforeUnmount, inject } from 'vue';\r
...
</template> `;var l=require("three"),Ce=async()=>{if(!navigator.gpu)return!1;try{return!!await navigator.gpu.requestAdapter()}catch(e){return console.error("WebGPU support check failed:",e),!1}},Se=e=>{e.traverse(t=>{t.geometry&&t.geometry.dispose(),t.material&&S(t.material)}),e.parent&&e.parent.remove(e)},S=e=>{if(Array.isArray(e)){e.forEach(S);return}Object.keys(e).forEach(t=>{let r=e[t];r&&r.isTexture&&r.dispose()}),e.dispose()},Re=(e,t)=>{let r=null;return(...n)=>{r!==null&&clearTimeout(r),r=window.setTimeout(()=>{e(...n)},t)}},Oe=(e,t)=>{let r=0;return(...n)=>{let s=Date.now();s-r>=t&&(r=s,e(...n))}},C=class{pool=[];createFn;resetFn;maxSize;constructor(t,r,n=0,s=100){this.createFn=t,this.resetFn=r,this.maxSize=s;for(let d=0;d<n;d++)this.pool.push(this.createFn())}get(){return this.pool.length>0?this.pool.pop():this.createFn()}release(t){this.pool.length<this.maxSize&&(this.resetFn(t),this.pool.push(t))}clear(){this.pool=[]}size(){return this.pool.length}},Pe=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{let t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)}),Me=()=>typeof Worker<"u",Ae=()=>typeof WebAssembly=="object"&&typeof WebAssembly.compile=="function"&&typeof WebAssembly.instantiate=="function",je=()=>typeof SharedArrayBuffer<"u",Be=()=>{let e=navigator.hardwareConcurrency||1,t=navigator.deviceMemory||4;return e>=8&&t>=8?"high":e>=4&&t>=4?"medium":"low"},Ie=e=>{switch(e){case"high":return{shadows:!0,shadowMapSize:2048,antialias:!0,physicallyCorrectLights:!0,maxLights:8,particleCount:1e4,textureSize:2048,geometryDetail:"high",postProcessing:!0};case"medium":return{shadows:!0,shadowMapSize:1024,antialias:!0,physicallyCorrectLights:!1,maxLights:4,particleCount:5e3,textureSize:1024,geometryDetail:"medium",postProcessing:!0};case"low":default:return{shadows:!1,shadowMapSize:512,antialias:!1,physicallyCorrectLights:!1,maxLights:2,particleCount:1e3,textureSize:512,geometryDetail:"low",postProcessing:!1}}},Le=e=>{let t=(e>>16&255)/255,r=(e>>8&255)/255,n=(e&255)/255;return[t,r,n]},Ne=e=>{let t=Math.round(e[0]*255),r=Math.round(e[1]*255),n=Math.round(e[2]*255);return(t<<16)+(r<<8)+n},Fe=(e,t,r)=>e+(t-e)*r,_e=(e,t,r)=>Math.max(t,Math.min(r,e)),De=e=>e*(180/Math.PI),He=e=>e*(Math.PI/180);function ze(e){return e?new l.Vector3(e[0],e[1],e[2]):new l.Vector3}function Ue(e){return e?new l.Quaternion(e[0],e[1],e[2],e[3]):new l.Quaternion}function ke(e){return e?new l.Euler(e[0],e[1],e[2]):new l.Euler}function Ve(e){return new l.Color(e)}function K(e){return new l.Box3().setFromObject(e)}function We(e){let t=K(e),r=new l.Sphere;return t.getBoundingSphere(r),r}var o=require("vue"),h=re(require("three"),1);var Tt=Symbol("three-render-context"),xt=Symbol("three-camera-context"),Ct=Symbol("three-scene-context"),St=Symbol("three-scene-symbol");var Rt=Symbol("three-geometry-context"),Ot=Symbol("three-geometry-symbol");var Pt=Symbol("three-material-context"),Mt=Symbol("three-material-symbol");var At=Symbol("three-mesh-context"),jt=Symbol("three-mesh-symbol");var Bt=Symbol("three-post-processing-context"),T=Symbol("three-canvas-context");var a={BLOOM:"bloom",DEPTH_OF_FIELD:"depthOfField",SSAO:"ssao",MOTION_BLUR:"motionBlur",OUTLINE:"outline",GLITCH:"glitch",NOISE:"noise",VIGNETTE:"vignette",TONE_MAPPING:"toneMapping",COLOR_CORRECTION:"colorCorrection",SSAA:"ssaa",FXAA:"fxaa",SMAA:"smaa",GOD_RAYS:"godRays",BOKEH:"bokeh",FILM:"film",HDR:"hdr",LUT:"lut",PIXELATE:"pixelate",CHROMATIC_ABERRATION:"chromaticAberration",SELECTIVE_BLOOM:"selectiveBloom",LENS_DISTORTION:"lensDistortion"},It=[a.SSAO,a.MOTION_BLUR,a.DEPTH_OF_FIELD,a.BLOOM,a.GOD_RAYS,a.HDR,a.LUT,a.COLOR_CORRECTION,a.CHROMATIC_ABERRATION,a.LENS_DISTORTION,a.NOISE,a.FILM,a.GLITCH,a.PIXELATE,a.VIGNETTE,a.OUTLINE,a.TONE_MAPPING,a.FXAA,a.SMAA,a.SSAA];function Ge(e,t){return(0,o.provide)(e.symbol,t),t}function Ye(e){return(0,o.inject)(e,null)}function Ke(e){return{parentApi:(0,o.inject)(e.symbol,null)}}function R(){let e=(0,o.inject)(T);if(!e)return console.error("useThree() \u5FC5\u987B\u5728 ThreeCanvas \u7EC4\u4EF6\u5185\u90E8\u4F7F\u7528"),{engine:(0,o.ref)(null),renderer:(0,o.ref)(null),scene:(0,o.ref)(null),camera:(0,o.ref)(null),gl:(0,o.ref)(null),size:(0,o.readonly)((0,o.ref)({width:0,height:0})),viewport:(0,o.readonly)((0,o.ref)({width:0,height:0,factor:1})),clock:(0,o.readonly)((0,o.ref)(new h.Clock)),pointer:(0,o.readonly)((0,o.ref)({x:0,y:0})),raycaster:(0,o.readonly)((0,o.ref)(new h.Raycaster)),ready:(0,o.ref)(!1)};let t=e.engine,r=(0,o.ref)(null),n=(0,o.ref)(null),s=(0,o.ref)(null),d=(0,o.ref)(null),c=(0,o.ref)({width:0,height:0}),m=(0,o.computed)(()=>{let i=r.value?.getPixelRatio?.()||1;return{width:c.value.width,height:c.value.height,factor:i}}),y=(0,o.ref)(new h.Clock),p=(0,o.ref)({x:0,y:0}),f=(0,o.ref)(new h.Raycaster),E=(0,o.ref)(!1),v=i=>{if(!e.containerRef.value)return;let b=e.containerRef.value.getBoundingClientRect(),g,x;"touches"in i?(g=i.touches[0].clientX,x=i.touches[0].clientY):(g=i.clientX,x=i.clientY),p.value.x=(g-b.left)/b.width*2-1,p.value.y=-((x-b.top)/b.height)*2+1},q=async()=>{if(t.value)try{if(r.value=await t.value.getRenderer?.(),n.value=await t.value.getScene?.(),s.value=await t.value.getCamera?.(),d.value=r.value?.getContext?.(),e.containerRef.value){let i=e.containerRef.value.getBoundingClientRect();c.value={width:i.width,height:i.height}}y.value.start(),E.value=!0,e.containerRef.value&&(e.containerRef.value.addEventListener("mousemove",v),e.containerRef.value.addEventListener("touchmove",v))}catch(i){console.error("\u521D\u59CB\u5316 three \u5BF9\u8C61\u5931\u8D25:",i)}},J=(i=[])=>{if(!s.value||!n.value||!f.value)return[];f.value.setFromCamera(p.value,s.value);let b=i.length>0?i:n.value.children.filter(g=>g.visible);return f.value.intersectObjects(b,!0)};return(0,o.onMounted)(()=>{t.value&&(q(),t.value.on?.("resize",i=>{c.value=i}))}),(0,o.onBeforeUnmount)(()=>{e.containerRef.value&&(e.containerRef.value.removeEventListener("mousemove",v),e.containerRef.value.removeEventListener("touchmove",v)),y.value.stop()}),{engine:t,renderer:(0,o.readonly)(r),scene:(0,o.readonly)(n),camera:(0,o.readonly)(s),gl:(0,o.readonly)(d),size:(0,o.readonly)(c),viewport:(0,o.readonly)(m),clock:(0,o.readonly)(y),pointer:(0,o.readonly)(p),raycaster:(0,o.readonly)(f),ready:(0,o.readonly)(E),raycast:J}}var u=require("vue");function Xe(e,t=0){let r=(0,u.inject)(T);if(!r){console.error("useFrame() \u5FC5\u987B\u5728 ThreeCanvas \u7EC4\u4EF6\u5185\u90E8\u4F7F\u7528");return}let{clock:n,scene:s,camera:d}=R(),c=(0,u.shallowRef)(e),m=null;return(0,u.onMounted)(()=>{if(!r.engine?.value)return;let p=r.engine.value,f=E=>{if(!n.value)return;let v=n.value.getDelta();c.value({clock:n.value,scene:s.value,camera:d.value,time:E},v)};p.beforeRender?m=p.beforeRender.subscribe(f,t):console.warn("\u5F15\u64CE\u4E0D\u652F\u6301 beforeRender \u4E8B\u4EF6\u8BA2\u9605")}),(0,u.onBeforeUnmount)(()=>{if(!r.engine?.value||m===null)return;let p=r.engine.value;p.beforeRender&&p.beforeRender.unsubscribe(m),m=null}),p=>{c.value=p}}var X={install(e){e.component("ThreeCanvas",P),e.component("ThreeScene",M),e.component("ThreeCamera",A),e.component("ThreeMesh",j),e.component("ThreeObject",B),e.component("ThreeResourceManager",I),e.component("ThreeWebGPURenderer",L),e.component("ThreePhysicsWorld",N),e.component("ThreeRigidBody",F),e.component("ThreeBoxCollider",_),e.component("ThreeSphereCollider",D),e.component("ThreeConstraint",H),e.component("ThreePostProcessing",z),e.component("ThreeBloomEffect",U),e.component("ThreeFXAAEffect",k),e.component("ThreeDepthOfFieldEffect",V),e.component("ThreeStats",W),e.component("ThreeRaycaster",G),e.component("ThreeInteractive",Y)}};0&&(module.exports={ObjectPool,ThreeRenderPlugin,arrayToEuler,arrayToQuaternion,arrayToVector3,clamp,computeBoundingBox,computeBoundingSphere,debounce,degreesToRadians,disposeMaterial,disposeObject,generateUUID,getDevicePerformanceLevel,getRenderQualitySettings,hexToRgb,injectThreeParent,isSharedArrayBufferSupported,isWebAssemblySupported,isWebGPUSupported,isWebWorkerSupported,lerp,radiansToDegrees,rgbToHex,throttle,toColor,useFrame,useParent,useProvideThreeAPI,useThree});
//# sourceMappingURL=three-render.cjs.js.map
