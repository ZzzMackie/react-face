<template>
  <div class="three-box-geometry"></div>
</template>
  ...
  setup(props, { emit }) {
    ...
    const createGeometry = async () => {
      ...
      try {
        ...
        console.error('Failed to create box geometry:', error);
      }
    };
